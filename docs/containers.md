...
Once you've installed one of those, you should clone the Gabe repo:
...
After this, [follow step 6 of the manual setup guide](https://docs.gabe.net/setup/#6-configure-the-bot). Make sure to leave the `DB` variable set to the default.
