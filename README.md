...
**gabe** is a Discord bot that's equipped with POWER, personality, and hell. Built with [Oceanic](https://oceanic.ws), it's strong and works well. 

## What Makes Gabe Special

- **Powerful Image Processing** - Turn your memes into masterpieces (or disasters) with [libvips](https://github.com/libvips/libvips) (Sorry, no memory optimization here).
...
- **Performance** - Low RAM and CPU utilization (**gabe** takes naps). If it looks low, that's normal.  <img src="https://github.com/thesomewhatyou/gabe/blob/5c064c85e67e56ef64d805c6a33f3d125f2d9492/images/favicon.png" align="right" width="128" height="128">
...
**New to gabe?** Check out the [Commands Documentation](https://thesomewhatyou.me/gabe/docs/commands) for a full guide to moderation and fun commands!
...
If you want to setup **gabe**, a guide can be found in the [Setup Guide](https://thesomewhatyou.me/gabe/docs/setup). A Docker container via GitHub Container Registry is also available. It is both an x86_64 container AND an ARM container. I mostly did this for the Raspberry Pi hosting freaks, but also because it's cheaper to host an ARM instance than an x86_64 instance.

## Let's Check Dis Out!

### 8-Ball demo
<img width="581" height="151" alt="are you fucking kidding me" src="https://github.com/user-attachments/assets/ce37810d-70f6-485b-a3d7-9fa952b87965" />

*i cry*


### Scott The Maniac
<img width="609" height="419" alt="FUCK YOU SCOTT THE WOZ" src="https://github.com/user-attachments/assets/342e0e9d-6a0d-42e6-af8b-af7a10923259" />
